...
M.canMathML();if(M.parseMathQ)try{
	//M.parseMath(document.body)
	//We want to selectively parse bits of the dom, not the entire thing.
}catch(exc){alert(exc)}});return M}();var M;if(M===undefined)M=jqMath;
